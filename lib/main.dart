...
import 'package:flutter_basics_project/widgets/new_transaction.dart';
import 'package:flutter_basics_project/widgets/transaction_list.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final txListWidget = Container(
              height: (MediaQuery.of(context).size.height- appBar.preferredSize.height - MediaQuery.of(context).padding.top) * 0.6,
                child: TransactionList(_userTransactions, _delteTransaction),
                );
